...
# sdkmanager --list
  ...
  system-images;android-26;google_apis;x86_64 | 16      | Google APIs Intel x86 Atom_64 System Image | system-images/android-26/google_apis/x86_64/
```
...
- Interactive way
  ```bash
  $ docker run -it --rm --device /dev/kvm androidsdk/android-26:latest bash
