...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "platforms;android-26"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "system-images;android-26;google_apis;x86_64"
